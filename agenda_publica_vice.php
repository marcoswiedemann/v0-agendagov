...
if (isLoggedIn()) {
    ...
    // Vice pode ver os seus
    if ($usuario_atual['papel'] === 'vice' && $usuario_atual['id'] === $id_vice) {
        $pode_ver_todos = true;
    }
}

// Obter compromissos do vice-prefeito para hoje
$sql = "SELECT id, titulo, data, hora, local, responsavel, observacoes, status, publico 
        FROM compromissos 
...
$stmt->execute([$data_atual, $id_vice]);
$compromissos_dia = $stmt->fetchAll();

$pageTitle = "Agenda do Vice-Prefeito - " . $data_formatada;
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body>
    ...
    <div class="header-banner">
        <div class="container text-center">
            <h1><i class="bi bi-person-badge-fill"></i> Agenda do Vice-Prefeito</h1>
            <p class="lead">
                Compromissos de <?php echo htmlspecialchars($nome_vice); ?> para <?php echo $data_formatada; ?> (<?php echo $nome_dia; ?>)
                        ...
                        <?php if (empty($compromissos_dia)): ?>
                            <div class="empty-state animate-fade-in">
                                ...
                                <p class="empty-state-description">
                                    O vice-prefeito não possui compromissos <?php echo $pode_ver_todos ? '' : 'públicos'; ?> agendados para esta data.
                                    ...
                                    <div class="col-md-6 mb-3 animate-fade-in" style="animation-delay: <?php echo $index * 0.1; ?>s;">
                                        <div class="card event-card h-100">
                                            <div class="card-body">
                                                ...
                                                <button class="btn btn-sm btn-outline-secondary mt-2" data-bs-toggle="modal" data-bs-target="#modalDetalhes<?php echo $compromisso['id']; ?>">
